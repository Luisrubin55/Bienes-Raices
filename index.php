...
?>
  ...
  <section class="imagen-contacto">
    ...
    <p>Llena el formulario de contacto y un asesor se pondra en contaco contigo a la brevedad</p>
  ...
  <div class="contenedor seccion seccion-inferior">
    <section class="blog">
      ...
      <article class="entrada-blog">
        <div class="imagen">
          <picture>
            <source srcset="build/img/blog1.wep" type="img/webp">
      ...
      <article class="entrada-blog">
        <div class="imagen">
          <picture>
            <source srcset="build/img/blog2.wep" type="img/webp">
    ...
    <section class="testimoniales">
      ...
      <div class="testimonial">
        <blockquote>
          El personal se comportó de una excelente forma, muy buena atencion y la casa que me ofrecieron cumple contodas mis expectativas
        </blockquote>
        <p>- Luis Armando Arenas </p>
      </div>
    </section>
  </div>
